...
export default function EditBookingModal({
  ...
  // Ensures that currentUser and booking are not null before accessing their properties
  const disableEditing = !isAdmin && booking && currentUser && booking.userId !== currentUser.id;
        ...
        <Form onSubmit={onSubmit}>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              disabled={!isAdmin} // Only admin can change status
            >
